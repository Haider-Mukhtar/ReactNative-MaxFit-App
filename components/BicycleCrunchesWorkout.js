...
import bicyclecrunches from '../assets/Workouts/bicyclecrunches';

const BicycleCrunchesWorkout = () => {

    const navigation = useNavigation();

    const data = bicyclecrunches[0];
...
export default BicycleCrunchesWorkout
